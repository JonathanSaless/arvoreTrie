#
#    Implementação de Lista Linear Duplamente Encadeada em Python 3
...
# "ponteiro" que identifica a ordem dos nodos. A lista duplamente encadeada
# guarda a referência para o primeiro nodo da lista e contém algumas funções
# para inserção, remoção, busca e percorrimento. Não há índices de posição
# nesse tipo de lista. Segue abaixo a implementação da classe bem como seus
# principais métodos, como o construtor, inserção de nodo no início e no fim,
# remoção e busca
#
...
class ListaDuplamenteEncadeada:
    ...
    def insereNodoNoInicio(self, nodo):
        ...
        # será atualizada, o ponteiro do próximo nodo no novo nodo raiz será
        # atualizado para o nodo raiz anterior, e o ponteiro do nodo anterior
        # ao nodo que era raiz apontará para o novo nodo
        else:
    ...
    def insereNodoNoFinal(self, nodo):
        ...
        # adicionado ao ponteiro proximoNodo do último nodo, e adiciona-se
        # a referência ao nodo anterior no nodo adicionado
        nodoAtual.proximoNodo = nodo
        nodo.anteriorNodo = nodoAtual
    ...
    def removeNodo(self, info):
        ...
        # nodoAtual, removendo-o da estrutura
        #
        # No caso do if, se nodoAtual.anteriorNodo == None, significa que o
        # nodo a ser removido é a própria raiz da lista. Assim, apenas
        # atualiza-se a referência à raiz da lista para o próximo nodo
        # disponível e configura-se o anterior para None
        if nodoAtual.anteriorNodo == None:
            self.raiz = nodoAtual.proximoNodo
            self.raiz.anteriorNodo = None
            nodoAtual.proximoNodo = None
            
        # Para o else atualiza-se o proximoNodo do anteriorNodo para o
